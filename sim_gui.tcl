...
grid [button .sim.selectfile -text "Choose tcl file:" -command simfile] -column 1 -row 1 -sticky we
...
grid [button .sim.run -text "Setup Simulator" -command run] -column 2 -row 8 -sticky e
