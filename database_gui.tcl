...
grid [label .db.glbl -text "g"] -column 1 -row 7 -pady 5 -sticky w
grid [label .db.nlbl -text "n"] -column 1 -row 8 -pady 5 -sticky w
...
grid [entry .db.g -textvariable db_g ] -column 2 -row 7 -pady 5 -sticky we
grid [entry .db.n -textvariable db_n ] -column 2 -row 8 -pady 5 -sticky we
grid [entry .db.r -textvariable db_r ] -column 2 -row 9 -pady 5 -sticky we
